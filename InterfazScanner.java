...
public class InterfazScanner{
	...
	switch(eleccion) {
        ...
        default:
			...
			System.out.println("No corresponde a ninguna opción, digite denuevo");
		    eleccion = 0;
	...
	switch(respuesta) {
       ...
       default:
			...
			System.out.println("No corresponde a ninguna opción");
		    respuesta = 0;
	...
	public void gana() {
		System.out.println("YEI!!! YOU WIN!!!");
		
		
	}
	public void abandona() {
		System.out.println("Has abandonado el Juego :c");
	}
	public void pierde() {
